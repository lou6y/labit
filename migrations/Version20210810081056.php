 ...
 */
final class Version20210810081056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, category_id_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, prix INT NOT NULL, date_ajout DATE NOT NULL, stock INT NOT NULL, description VARCHAR(255) NOT NULL, type TINYINT(1) NOT NULL, INDEX IDX_29A5EC279777D11E (category_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
